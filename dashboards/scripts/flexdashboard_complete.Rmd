...
### create slider input
## call function
            # name of input for programming
sliderInput("samp_size",
            # label of input for display
...
### Evaluate Accuracy of a Decision Tree for Performance Predictions
...
This highlights the accuracy of a single decision tree to predict performance on test data from the available predictors.
